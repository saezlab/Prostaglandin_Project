...
runPHONEMeS_Downsampling <- function(targets.P, conditions, dataGMM, experiments, bg, nIter = 100, nK="all", solver="cplex", case = case){
  ...
  for(ii in 1:nIter){
    ...
    write_lp_file(dataGMM = temp, pknList = pknList, targets = targets, experiments = conditions, case = case)
...
write_lp_file <- function(dataGMM, pknList, targets, experiments, case){
