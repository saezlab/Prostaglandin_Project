...
runPHONEMeS <- function(targets.P, conditions, dataGMM, experiments, bg, nK="all", solver="cplex", nSolutions=100, mipgap=0, relgap=0, replace=2, populate=5000, intensity=4, timelimit=3600, case = case){
  ...
  if(case==1){
    ...
    cascade=list(c1=c("PTGER1"),c2=c("GNAQ"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER1"),c2=c("ARRB"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("GNAQ"),c2=c("PLCB1"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("GNAQ"),c2=c("PLCG1"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    # cascade=list(c1=c("PLCB1"),c2=c("cPRKC"))
    # pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    # cascade=list(c1=c("PLCB1"),c2=c("CALM1"))
    # pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    # cascade=list(c1=c("PLCG1"),c2=c("cPRKC"))
    # pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    # cascade=list(c1=c("PLCG1"),c2=c("CALM1"))
    # pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
  ...
  if(case==2){
    ...
    cascade=list(c1=c("PTGER2"),c2=c("GNAS"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER2"),c2=c("ARRB"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
  ...
  if(case==3){
    ...
    cascade=list(c1=c("PTGER3"),c2=c("GNAI"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER3"),c2=c("GBG"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    # cascade=list(c1=c("PTGER3"),c2=c("GNA12"))
    # pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER3"),c2=c("ARRB"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
  ...
  if(case==4){
    ...
    cascade=list(c1=c("PTGER4"),c2=c("GNAI"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER4"),c2=c("GBG"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER4"),c2=c("GNAS"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
    cascade=list(c1=c("PTGER4"),c2=c("ARRB"))
    pknList <- addCascade(cascade = cascade, allD = allD, pknList = pknList)
  ...
  write_lp_file(dataGMM = dataGMM, pknList = pknList, targets = targets.P, experiments = conditions, 
                nSolutions=nSolutions, mipgap=mipgap, relgap=relgap, replace=replace, populate=populate, intensity=intensity, timelimit=timelimit, case = case)
...
write_lp_file <- function(dataGMM, pknList, targets, experiments, nSolutions, mipgap, relgap, replace, populate, intensity, timelimit, case){
  ...
  if(case==1){
    ...
    cascade=list(c1=c("PTGER1"),c2=c("GNAQ"))
    c8 <- cascadeConstraints(pknList = pknList, cascade = cascade, binaries = binaries)
    cascade=list(c1=c("PTGER1"),c2=c("ARRB"))
    c8 <- c(c8, cascadeConstraints(pknList = pknList, cascade = cascade, binaries = binaries))
    # cascade=list(c1=c("GNAQ"),c2=c("PLCB1"))
    # c8 <- c(c8, cascadeConstraints(pknList = pknList, cascade = cascade, binaries = binaries))
    # cascade=list(c1=c("GNAQ"),c2=c("PLCG1"))
    # c8 <- c(c8, cascadeConstraints(pknList = pknList, cascade = cascade, binaries = binaries))
  ...
  idx = which(grepl(pattern = " +  >= ", x = allC, fixed = TRUE))
  if(length(idx) > 0){
    allC = allC[-idx]
  }
