...
for(ii in 1:5){
  ...
  # sif2 = read_delim(paste0("CD4_sampling_exp", ii, ".txt"), "\t", escape_double = FALSE, trim_ws = TRUE)
  nodesAttributes = read_delim(paste0("nodesAttributes_", ii, ".txt"), "\t", escape_double = FALSE, trim_ws = TRUE)
  
  groupNodes(sif = sif1, nodesAttributes = nodesAttributes, sifName = paste0("cplex_grouped_", ii, ".txt"), attribName = paste0("attributes_grouped_cplex_", ii, ".txt"))
  # groupNodes(sif = sif2, nodesAttributes = nodesAttributes, sifName = paste0("sampling_grouped_", ii, ".txt"), attribName = paste0("attributes_grouped_sampling_", ii, ".txt"))
...
groupNodes(sif = sif1, nodesAttributes = nodesAttributes, sifName = paste0("cplex_grouped_combined.txt"), attribName = paste0("attributes_grouped_cplex_combined.txt"))
